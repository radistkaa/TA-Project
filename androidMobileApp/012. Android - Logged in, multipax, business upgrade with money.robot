...
*** Test Case ***
12. Android - Logged in, multipax, business upgrade with money
    [Tags]                                                PNR012    PNR_android
    Prepare Variables                                   ${origin}     ${destination}
    Create Random Flight Date Next X To Y Days              4         33                                       
    Book Flight On Finnair Operated Flight                  2          M
    Set Return Date    
    Book Return Flight                                      2          M     ${return_day}    ${return_month} 
    Add Passenger To Booking    ${pax_teemu_pukki}
